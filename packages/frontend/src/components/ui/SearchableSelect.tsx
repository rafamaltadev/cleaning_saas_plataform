    ...
    <div className="relative" ref={containerRef}>
      ...
      <div className="relative">
        <input
          type="text"
          autoComplete="off"
          className={`w-full h-10 px-3 ${selected ? 'pr-8' : ''} rounded bg-surface-alt border border-border text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200`}
        ...
        {selected && !open && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-primary text-base leading-none"
